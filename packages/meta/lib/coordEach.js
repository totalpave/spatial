...
function coordEach(geojson, callback, excludeWrapCoord) {
    ...
    for (var featureIndex = 0; featureIndex < stop; featureIndex++) {
        ...
        for (var geomIndex = 0; geomIndex < stopG; geomIndex++) {
            ...
            if (geometry === null)
                continue;
            coords = geometry.coordinates; //IDK why typescript was complaining, it thinks geometry is a GeometryCollection, regardless if I type assert it to Geometry.
...
//# sourceMappingURL=coordEach.js.map